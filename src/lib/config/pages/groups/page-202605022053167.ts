...
export const page: GroupPage = {
	...
	description: 'Our discipleship groups form the core of what we do. Each group consists of a Bible reading plan, a book to help the participant to grow in various aspects of the Christian faith, and one or two memory verses to memorize each week. Questions are provided for the readings to provide topics for group discussion and to reinforce the material being read. If it seems like a lot of work, know that as believers, we are expected to read our Bibles and pray for each other daily. We are also expected to study to show our selves approved, workers who do not need to be ashamed, but are rightly able to handle the word of truth.',
