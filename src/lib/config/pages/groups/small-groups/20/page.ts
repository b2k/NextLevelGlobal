...
export const page: GroupPage = {
	...
	description:
		'Next Level 20 is the second in a series of three introductory small group discipleship programs. See links below for more details or \n<a href=\"/about-us/contact-us\">Contact us</a> to learn more about how to get involved in a Next Level 20 small group.',
	menuTitle: '20',
			...
			items: [
				{
					...
					buyUrl:
						'https://www.christianbook.com/search-significance-getting-glimpse-worth-through/robert-mcgee/9780849944246/pd/944244',
		...
		},
		{
			...
			items: [
				...
				},
				{
					type: 'pdf',
					title: 'NKJV',
					pdf: '/groups/small-groups/20/lcv-nkjv-20.pdf'
				}
			]
		},
		{
